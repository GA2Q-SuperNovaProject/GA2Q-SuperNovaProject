...
SnakePlanetScene::SnakePlanetScene(eSceneName sceneName)
	: Scene(sceneName), m_isNowScene(false), m_isMusicStart(false)
{
}

SnakePlanetScene::~SnakePlanetScene()
{
}

void SnakePlanetScene::Update()
{
	...
	if (m_isMusicStart)
	{
		...
		SoundManager::PlaySounds(SOUND_SNAKE_PLANET);
...
//void SnakePlanetScene::LateUpdate()
//{
//}
